...
3 images across 1 spots. Licence rules and the OSM credit are in [the index](./README.md).

## Maryland Beach

`osm:node/358239306` · 38.4467793, -75.0499034

- **`us-md-maryland-beach-1.jpg`** — “Ocean City MD Sunrise” by Robert J Banach, Wikimedia Commons, CC BY-SA 4.0
  - Source page: https://commons.wikimedia.org/wiki/File:Ocean_City_MD_Sunrise.JPG
...
- **`us-md-maryland-beach-3.jpg`** ⚠︎ *context, not the coast itself* — Ocean City Maryland aerial view north — Public domain (Wikimedia Commons), no attribution required
  - Source page: https://commons.wikimedia.org/wiki/File:Ocean_City_Maryland_aerial_view_north.jpg
