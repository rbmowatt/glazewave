...
class BoardIndex extends Component {
  ...
  onSortUpdated = (prevQuery, nextQuery) => {
    let sortString = "";
    for (const [key, value] of Object.entries(nextQuery.sort[0])) {//we'll only ever have one sort so we can take the first element and parse it
  ...
  render() {
    ...
    return (
      <MainContainer>
        <ReactiveBase app="user_boards" url="http://192.168.99.101:9200">
          <div className="row">
